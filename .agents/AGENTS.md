...
<RULE[dondlingergc_canonical_domains]>
**18. Canonical Live Subdomains for dondlingergc.com:**
Always reference the ground-truth live subdomains and services for dondlingergc.com verified via Katana telemetry:
- Root Domain: https://dondlingergc.com (Main Web App)
- TAP Client: https://tap.dondlingergc.com (MudBlazor / Blazor WASM)
- Personalization Engine: https://personalization.dondlingergc.com (Metropolis Taskbar)
- Skydrop File Transfer: https://skydrop.dondlingergc.com (PeerJS, QR Code Scanner, ZLA Interop)
- Heckler Soundboard: https://heckler.dondlingergc.com (Blazor WASM Audio Engine)
- Timeline ZLA Engine: https://timelinezla.dondlingergc.com (WebRTC Sync, ZLA File Share, PDF Export)
- WaZ Weather Dashboard: https://wazweather.dondlingergc.com (Blazor WASM Weather Telemetry)
- Inspect Allamado Service: https://inspectallamado.dondlingergc.com
- Intake Service: https://intake.dondlingergc.com
</RULE[dondlingergc_canonical_domains]>
